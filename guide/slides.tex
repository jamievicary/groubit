...
%{\usebackgroundtemplate{\includegraphics[width=\paperwidth]{paid/quantum_small_transparent}}%
...
{
\picturefamily{
\uncover<2->{\node [anchor=north west] at (0,0) {\includegraphics[width=5cm]{images/nonfree/IBM}};}
\uncover<4->{\node [anchor=north west] at (-0.5,-0.75) {\includegraphics[height=3cm]{images/nonfree/UCSB}};}
}}
