...
\node at (0,0) {\includegraphics[height=3cm]{images/photoniccomputer}};
...
\[\begin{aligned}\begin{tikzpicture}
\uncover<4->{\node at (0,0) {\includegraphics[height=3cm]{images/teleportation}};}
\end{tikzpicture}\end{aligned}\]
}
...
\vgap
\uncover<3->{\step a Alice and Bob, both store 0 in your qubits}

\vgap
\uncover<4->{\step b Alice and Bob, both press \inlineH}

\vgap
\uncover<5->{\step c Alice and Bob, connect a cable and both press \inlineCZ}
...
\vgap\uncover<8->{\step 2 Charlie, press random buttons, then press \inlineM to get your \textit{secret number}}

\vgap\uncover<9->{\step 3 Bob and Charlie, connect a cable, and both press \inlineCZ}

\vgap\uncover<10->{\step 4 Bob, press \inlineH then \inlineM. If the answer is 1, then Alice press \inlineZ}

\vgap\uncover<11->{\step 5 Alice, press \inlineH}

{\vgap\uncover<12->{\bf Charlie's qubit has now been teleported to Alice!}}

%\vspace{10pt} \textit{Step 6.} Alice, press \inlineH then \inlineM. If the answer is 1, then Charlie press \inlineZ.

\vgap\uncover<13->{\step 6 Alice, press \inlineM to discover {Charlie's secret number}}
...
Here's a plan for a quantum computer under construction in the UK:
...
\uncover<5->{\item Teleportation}
\end{itemize}
\uncover<6->{But \textit{when} will quantum computers arrive?}
\vspace{-10pt}
\end{minipage}
...
\vspace{20pt}
\uncover<7->{In 2017, IBM revealed a 50-qubit machine.}

\vgap
\uncover<8->{A few weeks ago, Google revealed a 72-qubit machine.}

\vgap
\uncover<9->{\textit{The quantum revolution is about to begin!}}
}
{
\picturefamily{
\uncover<7->{\node [anchor=north west] at (0,0) {\includegraphics[height=3cm]{images/nonfree/IBM}};}
\uncover<8->{\node [anchor=north west] at (0.5,-0.5) {\includegraphics[height=3cm]{images/bristlecone}};}
}}
